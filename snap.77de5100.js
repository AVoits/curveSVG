...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"tracks/tracks.const.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CONTROL_DISTANCE = void 0;
exports.CONTROL_DISTANCE = 100;
...
exports.Curve = exports.Arc = exports.Point = exports.PointType = void 0;

var tracks_const_1 = require("../tracks/tracks.const");
...
(function (PointType) {
  PointType["anchorStart"] = "anchorStart";
  PointType["anchorEnd"] = "anchorEnd";
  PointType["controlStart"] = "controlStart";
  PointType["controlEnd"] = "controlEnd";
...
var Point = function () {
  ...
  Point.prototype.controlMoveHandler = function (dx, dy) {
    this.x = this.x + dx;
    this.y = this.y + dy;
  };
...
var Arc = function () {
  ...
  Arc.prototype.makeControlStart = function (point) {
    var newCoordinate = {
      x: point.x,
      y: point.y - tracks_const_1.CONTROL_DISTANCE
    };
    return newCoordinate;
  };

  Arc.prototype.makeControlEnd = function (point) {
    var newCoordinate = {
      x: point.x,
      y: point.y + tracks_const_1.CONTROL_DISTANCE
    };
...
var Curve = function () {
  ...
  Curve.prototype.moveAnchor = function (point, dx, dy, x, y) {
    ...
    var currentArc = this.arcs[indexArc];
  ...
  Curve.prototype.splitArc = function (arc, x, y) {
    var uuidFirst = uuid_1.v4();
    var uuidSecond = uuid_1.v4();
  ...
  Curve.prototype.addAnchor = function (arc, x, y) {
    var _a; // @ts-ignore


    var currentArcIndex = this.arcs.findIndex(function (item) {
      return arc.arcID === item.arcID;
    });
    var newArcs = this.splitArc(arc, x, y);

    if (currentArcIndex !== -1) {
      (_a = this.arcs).splice.apply(_a, __spreadArray([currentArcIndex, 1], newArcs));
    }
  };
  ...
  Curve.prototype.deleteAnchor = function (point) {
    // @ts-ignore
    var indexArc = this.arcs.findIndex(function (item) {
      return item.arcID === point.arcID;
    });
    ...
    var newArc = this.joinArcs(prevArc, currentArc);
    this.arcs.splice(indexArc - 1, 2, newArc);
  };

  Curve.prototype.changeArcColor = function (arc, color) {
    arc.arcColor = color;
  };
...
exports.Curve = Curve;
},{"../tracks/tracks.const":"tracks/tracks.const.ts","uuid":"node_modules/uuid/dist/esm-browser/index.js"}],"node_modules/eve/eve.js":[function(require,module,exports) {
var define;
...
},{}],"node_modules/snapsvg/dist/snap.svg.js":[function(require,module,exports) {
var define;
...
},{"eve":"node_modules/eve/eve.js"}],"curve/colorsMaterial.ts":[function(require,module,exports) {
"use strict";
...
},{}],"curve/view.ts":[function(require,module,exports) {
"use strict";
...
var CurveView = function () {
  function CurveView(curve, handlers) {
    this.defaultColor = colorsMaterial_1.MaterialColors.Pink["500"];
    this.controlStartColor = '#00ffe8';
    this.controlEndColor = '#ee00ff';
    this.curve = curve;
    this.field = Snap("#svg");
    this.handlers = handlers;
  }

  CurveView.prototype.render = function () {
    var _this = this;

    this.field.clear();
    this.curve.arcs.map(function (arc, index, arr) {
      _this.drawPath(arc);

      _this.drawControls(arc);

      _this.drawAnchor(arc.anchorStart);

      if (index === arr.length - 1) {
        _this.drawAnchor(arc.anchorEnd);
      }
    });
    this.drawHelpInfo();
  };
  ...
  CurveView.prototype.drawControls = function (arc) {
    ...
    this.field.circle(arc.controlStart.x, arc.controlStart.y, 5).attr({
      fill: this.controlStartColor
    }).drag(function (dx, dy, x, y, event) {
      return _this.handlers.onPointMove(arc.controlStart, dx, dy, x, y, event);
    }, this.onStart, this.onStop);
    this.field.line(arc.controlStart.x, arc.controlStart.y, arc.anchorStart.x, arc.anchorStart.y).attr({
      stroke: this.controlStartColor,
      'strokeWidth': 1,
      strokeDasharray: '5'
    });
  ...
  CurveView.prototype.drawPath = function (arc) {
    var _this = this;

    var path = this.getPathString(arc);
    this.field.path(path).attr({
      stroke: arc.arcColor || this.defaultColor,
      'strokeWidth': 4,
      fill: 'none',
      opacity: 0.8
    }).dblclick(function (e) {
      return _this.handlers.onAddAnchor(arc, e);
    }).click(function (e) {
      return _this.handlers.onChangePathColor(arc, e);
    });
  };

  CurveView.prototype.drawAnchor = function (point) {
    var _this = this;

    this.field.circle(point.x, point.y, 10).attr({
      fill: 'pink'
    }).dblclick(function (e) {
  ...
  CurveView.prototype.onStart = function () {};

  CurveView.prototype.onStop = function () {};

  CurveView.prototype.getPathString = function (arc) {
    var M = "M " + arc.anchorStart.x + "," + arc.anchorStart.y;
    var controlStart = arc.controlStart.x + "," + arc.controlStart.y;
    var controlEnd = arc.controlEnd.x + "," + arc.controlEnd.y;
...
},{"snapsvg":"node_modules/snapsvg/dist/snap.svg.js","./colorsMaterial":"curve/colorsMaterial.ts"}],"curve/controller.ts":[function(require,module,exports) {
"use strict";
...
var Controller = function () {
  ...
  Controller.prototype.anchorAddHandler = function (arc, event) {
    this.model.addAnchor(arc, event.x, event.y);
    this.view.render();
  };

  Controller.prototype.anchorDeleteHandler = function (point, event) {
    this.model.deleteAnchor(point);
    this.view.render();
  };

  Controller.prototype.pathChangeColor = function (arc) {
    var colors = Object.keys(colorsMaterial_1.MaterialColors);
    var item = colors[Math.floor(Math.random() * colors.length)];
    var color = colorsMaterial_1.MaterialColors[item][500];
...
},{"./model":"curve/model.ts","./view":"curve/view.ts","./colorsMaterial":"curve/colorsMaterial.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
},{}]},{},["../../AppData/Roaming/nvm/v14.17.6/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
//# sourceMappingURL=/snap.77de5100.js.map